    ...
    <tr>
        <td>
            <table style="background-color: white; max-width:670px;  margin:0 auto;" width="100%" border="0"
                ...
                <tr>
                    <td class="rectangle_image">
                        {{--                        <img src="https://res.cloudinary.com/sprintcorp/image/upload/v1624538403/wesonline/email/Rectangle_1459_h5yrb7.png" title="logo" alt="logo">--}}
                    </td>
                </tr>
                <tr>
                    <td>
